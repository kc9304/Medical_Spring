...
const Admin = () => {
  ...
  return (
    <div className="body">
      ...
      {/* Cards for "View All Doctors," "View All Patients," and "Add Doctor" */}
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: '40px' }}>
        ...
        >
          <Link to="/doctors" style={{ textDecoration: 'none', color: 'white', fontSize: '1.5vw', transition: 'color 0.3s' }}>
            View All Doctors
          </Link>
        </div>
        ...
        >
          <Link to="/patients" style={{ textDecoration: 'none', color: 'white', fontSize: '1.5vw', transition: 'color 0.3s' }}>
            View All Patients
          </Link>
        </div>
        ...
        >
          <Link to="/addD" style={{ textDecoration: 'none', color: 'white', fontSize: '1.5vw', transition: 'color 0.3s' }}>
            Add Doctor
          </Link>
        </div>
      </div>
